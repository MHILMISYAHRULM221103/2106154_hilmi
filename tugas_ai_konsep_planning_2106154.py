# -*- coding: utf-8 -*-
"""tugas AI konsep planning_2106154

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xChuq6n5AeNZU0RmzpNhn5Qnhlis_GZG
"""
    ...
    def get_steps(self): 
        ...
        if _name_ == '_main_':
          ...
          goal_state = [
              ...
              CLEAR('R'), CLEAR('B'), CLEAR('G'), CLEAR('Y'),
              ARMEMPTY()
          ]
          initial_state_3 = [
              ON('a','b'), ON('e','d'), 
              ONTABLE('b'), ONTABLE('c'), 
              CLEAR('c'), CLEAR('a'), CLEAR('e'),
              ARMEMPTY()
          ]
          goal_state = [
